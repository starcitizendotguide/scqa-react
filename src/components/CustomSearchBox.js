...
function CustomSearchBox(props) {
    ...
    return (
        <div className="flex items-center w-full"> 
            <select
                className="mr-2 bg-transparent text-gray-200 border-b-2 border-sc-blue-100 focus:outline-none focus:ring-0 h-10" 
            ...
            >
                <div className="relative z-0 w-full group">
                    <input
                        className="block font-bold py-2 px-0 w-full text-lg text-gray-200 bg-transparent border-0 border-b-2 focus:outline-none focus:ring-0 focus:border-sc-blue-100 peer h-10" // Adjusted height to match dropdown
                        type="search"
                        id="searchbox"
                        placeholder=''
                        autoComplete='off'
