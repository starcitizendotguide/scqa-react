            ...
            toggles={
              <>
                <label className="inline-flex items-center cursor-pointer">
                  ...
                  <span className="ms-3 text-sm font-medium text-gray-200">Highlight Matches <i className={`fas fa-highlighter ${highlightQuery ? 'text-yellow-400' : 'text-gray-200'}`}></i></span>
                </label>
              </>
            }
          />
